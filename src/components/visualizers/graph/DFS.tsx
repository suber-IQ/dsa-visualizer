...
import { dfsTraversal } from "../../../utils/graphUtils";
...
const DFS = () => {
  ...
  useEffect(() => {
    if (isRunning && algorithm === "DFS") {
      dfsTraversal(START_NODE, setVisited, dispatch);
    }
  }, [isRunning, algorithm, dispatch, START_NODE]);

  // ✅ Reset grid and clear visited nodes
  const resetGrid = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      {/* <h1 className="text-xl font-bold mb-4">DFS Traversal Visualization</h1> */}
